<!DOCTYPE html><%!
  public String ping(String s) {
   ...
   return "[INFO] "+new java.util.Date().getTime()+":  "+s;
  }
%>
<%
    ...
    <td>
     <div style="position:relative">
      <img style="z-index:2;left:0px;top:0;position:relative" alt="DigitalPlanetSplash"
       src="https://bigtablenomic.googlecode.com/files/DigitalPlanetSplash.png"/>
      <div style="z-index:4;left:0px;top:0;position:absolute">
       <canvas id="pane" width="780" height="600" onclick="click(this)"></canvas>
      </div>
      <div id="browser" style="z-index:5;left:130px;top:180;position:absolute;background:white;padding:8px;display:none">
       <p>We're sorry, but your WebBrowser (probably <a href="http://gawker.com/5826643/internet-explorer-users-are-objectively-stupid">InternetExplorer</a>?) is too old.</p>
       <p>Please upgrade to a better one:</p>
       <a href="https://chrome.google.com/">
        <img src="https://www.google.com/intl/en/chrome/assets/common/images/chrome_logo_2x.png"/></a>
       <a href="https://www.mozilla.org/firefox">
        <!-- http://de.wikipedia.org/wiki/Datei:Mozilla_Firefox_Logo_mit_Schriftzug.png -->
        <img src="http://upload.wikimedia.org/wikipedia/de/thumb/3/37/Mozilla_Firefox_Logo_mit_Schriftzug.png/320px-Mozilla_Firefox_Logo_mit_Schriftzug.png"
        width="240" height="80"/></a>
      </div>
      <!--img src="TMPEarthNav.png" onclick="rotZ=(rotZ+3)%4;draw()"
       style="left:-350px;top:-100px; z-index:6;position:absolute;clip:rect(40px,600px,230px,380px);"/-->
     <div id="nav">
      <div style="z-index:15;left:0px;top:0;position:absolute">
       <img src="http://upload.wikimedia.org/wikipedia/commons/8/8c/Transparent.png"
        width="150" height="150" border="0" alt="Navigation" usemap="#navMap"
        style="left:0px;top:0;position:relative"/>
       <!-- Created by Online Image Map Editor (http://www.maschek.hu/imagemap/index) -->
       <map name="navMap">
<area shape="poly" alt="rotate X +" title="rotate X +" coords="11,103,11,88,33,78,57,81,75,97,60,106,44,100,33,99,19,106" href="javascript:rot(rotX,1)"/>
<area shape="poly" alt="rotate X -" title="rotate X -" coords="10,133,19,125,32,133,47,132,60,127,71,138,52,146,37,147,17,143" href="javascript:rot(rotX,3)"/>
<area shape="poly" alt="rotate Y +" title="rotate Y +" coords="115,49,120,55,110,79,110,90,121,112,108,122,92,88,95,64,104,52" href="javascript:rot(rotY,1)"/>
<area shape="poly" alt="rotate Y -" title="rotate Y -" coords="122,47,129,34,146,44,151,67,150,91,132,113,122,100,131,83,131,64" href="javascript:rot(rotY,3)"/>
<area shape="poly" alt="rotate Z +" title="rotate Z +" coords="45,25,63,11,115,9,117,31,88,30,82,23,67,24,50,32,45,29" href="javascript:rot(rotZ,1)"/>
<area shape="poly" alt="rotate Z -" title="rotate Z -" coords="61,34,69,25,86,28,91,42,78,48,63,45" href="javascript:rot(rotZ,3)"/>
...
<area shape="poly" alt="" title="3" coords="101,37,107,44,97,56,65,61,36,52,40,29,53,37,63,46,79,47" href="" target="" /-->
      ...
      <div
       style="left:145px;top:3px;z-Index:8;position:absolute;background:grey;font-size:9pt;padding:6px">
